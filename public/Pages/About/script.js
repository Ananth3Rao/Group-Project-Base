  ...
  form.addEventListener('submit', async (event) => {
    ...
    if (search.value.length > 0) {
      ...
      filtered.forEach((item) => {
        ...
        appendItem.innerHTML = `<div class='box'><div class='columns'><div class='column'><div class="list-header is-size-5"><a href='../Hotels/hotel${item.hotel_id}.html'>${item.hotel_name}</a></div>
