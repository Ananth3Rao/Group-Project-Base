async function dataHandler() {
    ...
    appendItem.innerHTML = `<div class="box"><h3 class="title is-3">${result[1].restaurant_name}</h3><div class="image"><img src="${result[1].restaurant_id}.png"/></div></div>`;
    targetList1.append(appendItem);
    console.log(result[1].restaurant_id)
